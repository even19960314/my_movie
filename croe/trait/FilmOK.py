...
<li class="sm">评分次数：<span>(.*?)</span></li>',
    ...
    def film_search(self, keyword, encoding = None):
        ...
        post_url = 'http://www.jisudhw.com/index.php?m=vod-search'
    ...
    def get_show_page_info(self,url):
        ...
        regex = dict(
                ...
                info = '<li><span class="tt"></span><span class="xing_vb4"><a href="(.*?)" target="_blank">(.*?)</a></span> <span class="xing_vb5">(.*?)</span> <span class=".*?">(.*?)</span></li>'
    ...
    def get_all_show_page_url(self):
        ...
        url = 'http://www.jisudhw.com/?m=vod-index-pg-{}.html'
        
        self.queue = [url.format(i) for i in range(1, 666)]
...
if __name__ == '__main__':
    ...
    url = 'http://www.jisudhw.com/?m=vod-index-pg-2.html'
